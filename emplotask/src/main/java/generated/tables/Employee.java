...
public class Employee extends TableImpl<EmployeeRecord> {
    ...
    private static final long serialVersionUID = 806946261;
    ...
    /**
     * The column <code>emplotask.employee.boss</code>.
     */
    public final TableField<EmployeeRecord, String> BOSS = createField(DSL.name("boss"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
